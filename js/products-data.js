...
const productsData = {
    indoor: {
        ...
        'down-light': [
            ...
            { name: 'LL-2007', img: 'LL-2007-7W.png', pdf: 'LL-2007.pdf' },
            ...
            { name: 'LL-4003', img: 'LL-4003-WH.png', pdf: 'LL-4003.pdf' },
        ],
        'lamps-tubes': [
            { name: 'T8', img: 'T8.png', pdf: 'T8.pdf' },
            { name: 'LL-MR16', img: 'LL-MR.png', pdf: 'LL-MR16.pdf' },
            { name: 'LL-GU10', img: 'LL-GU.png', pdf: 'LL-GU10.pdf' },
            { name: 'LL-E14', img: 'LL-E14.png', pdf: 'LL-E14.pdf' },
            { name: 'T5', img: 'T5.png', pdf: 'T5.pdf' },
            { name: 'LL-E27', img: 'LL-E27.png', pdf: 'LL-E27.pdf' },
        ],
        'strip-light': [
            { name: 'SL-LL-3014', img: 'SL-LL-3014.png', pdf: 'LL-3014.pdf' },
            { name: 'SL-LL-3015', img: 'SL-LL-3015.png', pdf: 'LL-3015.pdf' },
        ...
        'chandelier-pendant': [
            ...
            { name: 'LL-310-1', img: 'LL-310-1-SQ.png', pdf: 'LL-310-1.pdf' },
            ...
            { name: 'LL-816', img: 'LL-816.png', pdf: 'LL-816.pdf' },
        ],
    },
    outdoor: {
        'industrial-light': [
        ...
        'up-light': [
            { name: 'LL-4401', img: 'LL-4401.png', pdf: 'LL-4401.pdf' },
            { name: 'LL-4402', img: 'LL-4402.png', pdf: 'LL-4402.pdf' },
            ...
            { name: 'LL-4407', img: 'LL-4407.png', pdf: 'LL-4407.pdf' },
            { name: 'LL-4408', img: 'LL-4408.png', pdf: 'LL-4408.pdf' },
        ...
        'flood-light': [
            { name: 'FD-LL-4401', img: 'FD-LL-4401.png', pdf: 'LL-4401.pdf' },
            { name: 'FD-LL-4402', img: 'FD-LL-4402.png', pdf: 'LL-4402.pdf' },
            { name: 'FD-LL-4407', img: 'FD-LL-4407.png', pdf: 'LL-4407.pdf' },
            { name: 'FD-LL-4408', img: 'FD-LL-4408.png', pdf: 'LL-4408.pdf' },
            { name: 'BL-LL-4407', img: 'BL-LL-4407.png', pdf: 'LL-4407.pdf' },
            { name: 'BL-LL-4408', img: 'BL-LL-4408.png', pdf: 'LL-4408.pdf' },
            { name: 'LL-BL-4007', img: 'LL-BL-4007.png', pdf: 'LL-BL-4007.pdf' },
            { name: 'LL-BL-4008', img: 'LL-BL-4008.png', pdf: 'LL-BL-4008.pdf' },
            { name: 'PL-4609', img: 'PL-4609.png', pdf: 'PL-4609.pdf' },
        ],
    }
};
...
function generateProductCards() {
    ...
    Object.keys(productsData.indoor).forEach(type => {
        productsData.indoor[type].forEach(product => {
            ...
            html += `
                <div class="spotlight-product-card product-card" data-category="indoor" data-type="${type}" data-product-name="${product.name}" data-product-pdf="${product.pdf}" data-product-img="${product.img}" data-product-desc="${description.replace(/"/g, '&quot;')}">
    ...
    Object.keys(productsData.outdoor).forEach(type => {
        productsData.outdoor[type].forEach(product => {
            ...
            const description = product.description || `Premium ${getCategoryName(type).toLowerCase()} solution designed for modern lighting applications.`;
            html += `
                <div class="spotlight-product-card product-card" data-category="outdoor" data-type="${type}" data-product-name="${product.name}" data-product-pdf="${product.pdf}" data-product-img="${product.img}" data-product-desc="${description.replace(/"/g, '&quot;')}">
                    <div class="product-image-wrapper">
                        <img src="${imgPath}" alt="${product.name}" loading="lazy" onerror="this.src='https://via.placeholder.com/200x200?text=${product.name}'">
                    </div>
                    <div class="product-info">
...
function updateThumbnailGallery(images) {
    ...
    images.forEach((img, index) => {
        ...
        const existing = thumbnailGallery.querySelector(`img[src="assets/img/${img}"]`);
        if (existing) return;
        
        const thumbnail = document.createElement('img');
        thumbnail.src = `assets/img/${img}`;
        thumbnail.alt = `Product Image ${index + 1}`;
        thumbnail.loading = 'lazy';
        thumbnail.className = index === 0 ? 'thumbnail active' : 'thumbnail';
        thumbnail.addEventListener('click', () => {
            document.getElementById('modalMainImage').src = `assets/img/${img}`;
...
function setupProductModal() {
    ...
    openButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            if (titleEl && descEl && imgEl && pdfEl) {
                    ...
                    for (let i = 1; i <= 10; i++) {
                        ...
                        variations.forEach(variation => {
                            ...
                            img.onload = function() {
                                ...
                                thumbnail.loading = 'lazy';
                                thumbnail.addEventListener('click', () => {
                                    imgEl.src = `assets/img/${variation}`;
                                    thumbnailGallery.querySelectorAll('img').forEach(t => t.classList.remove('active'));
                                    thumbnail.classList.add('active');
                                });
                                thumbnail.addEventListener('error', () => {
                ...
                if (mainImgEl) mainImgEl.src = `assets/img/${productImg}`;
                if (viewPdfEl) viewPdfEl.href = `assets/pdfs/${productPdf}`;
                if (downloadPdfEl) downloadPdfEl.href = `assets/pdfs/${productPdf}`;
    ...
    viewDetailsBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            const productPdf = btn.getAttribute('data-product-pdf');
            ...
            if (nameEl) nameEl.textContent = productName;
            if (mainImgEl) mainImgEl.src = `assets/img/${productImg}`;
            if (pdfEl) pdfEl.href = `assets/pdfs/${productPdf}`;
